def slice_me(family: list, start: int, end: int) -> list:
    ...
    """fonction qui recoit une liste et 2 parametres et retourne une version tronquée si necessaire en fonction du start et du end 
    et affiche les shapes avant et après la découpe"""

    if family is None or not isinstance(family, list) or len(family) == 0:
        raise ValueError("family doit être une liste non vide")

    if not isinstance(start, int) or not isinstance(end, int):#retour boolean si start et end sont des entiers
